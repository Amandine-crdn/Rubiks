...
#     C0.set_color(c2[1] + c2[2] + c2[0])
#     C2.set_color(c6[0] + c6[1] + c6[2]) 
#     C4.set_color(c0[1] + c0[2] + c0[0]) 
#     C6.set_color(c4[0] + c4[1] + c4[2]) 
...
#     C4.set_color(c6[1] + c6[2] + c6[0])#✔️
#     C5.set_color(c4[1] + c4[2] + c4[0])#✔️
#     C6.set_color(c7[1] + c7[2] + c7[0])#✔️
