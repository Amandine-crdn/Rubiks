...
s_A0 = Node(value=0, color=aretes[0])
s_A1 = Node(value=1, color=aretes[1])
s_A2 = Node(value=2, color=aretes[2])
s_A3 = Node(value=3, color=aretes[3])
s_A4 = Node(value=4, color=aretes[4])
s_A5 = Node(value=5, color=aretes[5])
s_A6 = Node(value=6, color=aretes[6])
s_A7 = Node(value=7, color=aretes[7])
s_A8 = Node(value=8, color=aretes[8])
s_A9 = Node(value=9, color=aretes[9])
s_A10 = Node(value=10, color=aretes[10])
s_A11 = Node(value=11, color=aretes[11])


s_A0.setter(u=s_A1, uprime=s_A2, b=s_A9, bprime=s_A4)
s_A1.setter(l=s_A4, lprime=s_A5, u=s_A3, uprime=s_A0)
s_A2.setter(r=s_A7, rprime=s_A9,  u=s_A0, uprime=s_A3)
s_A3.setter(f=s_A5, fprime=s_A7,  u=s_A2, uprime=s_A1)
s_A4.setter(l=s_A6, lprime=s_A1,  b=s_A0, bprime=s_A11)
s_A5.setter(l=s_A1, lprime=s_A6,  f=s_A8, fprime=s_A3)
s_A6.setter(l=s_A5, lprime=s_A4,  d=s_A11, dprime=s_A8)
s_A7.setter(r=s_A10, rprime=s_A2,  f=s_A3, fprime=s_A8)
s_A8.setter(d=s_A6, dprime=s_A10, f=s_A7, fprime=s_A5)
s_A9.setter(r=s_A2, rprime=s_A10, b=s_A11, bprime=s_A0)
s_A10.setter(r=s_A9, rprime=s_A7, d=s_A8, dprime=s_A11)
s_A11.setter(b=s_A4, bprime=s_A9, d=s_A10, dprime=s_A6)
